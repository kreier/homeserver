...
Documentation on my journey to a small but capable homelab. The setup currently consists of :material-router: 2 routers, :material-switch: 1 managed switch, :material-server: 3 always-on servers, and :material-brain: one LLM server activated on demand.
